...
HelloTextureScene::HelloTextureScene(RenderContext &renderContext) : BaseScene(renderContext),
                                                                     m_shader("assets/shaders/vertex/simple_uv.vert", "assets/shaders/fragment/simple_texture.frag"),
